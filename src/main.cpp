...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x00000e373f7cb71247148afe930d6860dfe6b0aa73a85e8aa75cd9d7eea9bff9");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Meatballcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Meatballcoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000e373f7cb71247148afe930d6860dfe6b0aa73a85e8aa75cd9d7eea9bff9");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MeatballcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MeatballcoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MeatballcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Meatballcoin-miner");
    ...
    try { loop {
        ...
        printf("Running MeatballcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MeatballcoinMiner terminated\n");
        throw;
    }
}
